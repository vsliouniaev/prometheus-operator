...
func testOperatorNSScope(t *testing.T) {
	...
	t.Run("SingleNS", func(t *testing.T) {
		...
		_, err := framework.CreatePrometheusOperator(operatorNS, *opImage, []string{mainNS})
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("MultiNS", func(t *testing.T) {
		...
		_, err := framework.CreatePrometheusOperator(operatorNS, *opImage, []string{prometheusNS, ruleNS})
		if err != nil {
			t.Fatal(err)
		}
